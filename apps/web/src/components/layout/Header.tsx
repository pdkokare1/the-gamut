...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full mb-6">
      ...
      {/* We add a subtle margin top on desktop for a 'floating' feel */}
      <div className={cn(
        "glass px-4 h-16 flex items-center justify-between mx-auto max-w-7xl transition-all duration-300",
        "rounded-b-xl md:rounded-b-2xl md:mt-2" 
      )}>
        ...
        <div className="flex items-center gap-1 md:gap-2">
          ...
          <Link to="/profile">
            <Button variant="ghost" size="icon" className="relative group">
              <div className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center border border-border group-hover:border-primary transition-colors overflow-hidden">
